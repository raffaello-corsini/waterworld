...
namespace Ariadne {
  ...
  HybridIOAutomaton getSystem()
  {
    ...
    */
    ...
    // Creo il parametro d'uscita. Sarà solo uno, quello dell'ultima watertank.
    // Le uscite delle altre watertank saranno decise in maniera dinamica.
    ...
    */
    tank0.set_dynamics(flow0, waterLevel0, - tankOutputFlow *  ( valveLevel2 / 2 ) * waterLevel0 + w0in * valveLevel0);
    tank1.set_dynamics(flow1, waterLevel1, - tankOutputFlow *  ( valveLevel2 / 2 ) * waterLevel1 + w1in * valveLevel1);
    ...
    */
    ...
    tank2.set_dynamics(flow2, waterLevel2,
      ...
      + tankOutputFlow *  ( valveLevel2 / 2 ) * waterLevel1);
